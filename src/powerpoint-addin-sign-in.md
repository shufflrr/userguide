...
This add-in works with **Office 365 PowerPoint**. You sign in once to connect **OneDrive**, **Shufflrr**, and **SharePoint** in the task pane.
...
1. In PowerPoint, open **Add-ins** on the **Home** ribbon, or use the **Shufflrr** button in the ribbon (under **Files – Data** next to Designer / Copilot) to open the task pane.
...
| Add-in doesn't load | PowerPoint environment is not supported | Use **Office 365 PowerPoint**. |
...
3. Locate **SharePoint**.
4. Click **Connect**.
5. When prompted, complete Microsoft sign-in by choosing your account or using another account.
