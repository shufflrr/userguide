...
- [Shufflrr Add-in]()
    ...
    - [Shufflrr AI](powerpoint-addin-ai.md)
    - [Insert slides and images](powerpoint-addin-find-insert-slides.md)
- [Shufflrr Cloud]()
    ...
    - [Presentations](presentations.md)
        ...
        - [Slide Updating](presentations-slide-updating.md)
    ...
    - [Test Section](test-section.md)
        - [Test Sub-page](test-sub-page.md)
